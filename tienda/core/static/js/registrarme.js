$(document).ready(function () {
  ...
  $("#id_username").attr("placeholder", "Ej: IPeralta, JRivero, FTapia");
  $("#id_first_name").attr("placeholder", "Ej: Ignacio, Jose, Felipe");
  $("#id_last_name").attr("placeholder", "Ej: Peralta, Rivero, Tapia");
  $("#id_email").attr("placeholder", "Ej: JKlauss@correo.com");
  ...
  $("#id_direccion").attr(
    "placeholder",
    "Calle, n° casa o edificio, n° departamento o piso\n" +
  ...
  $("#form").validate({
    ...
    messages: {
      ...
      last_name: {
        ...
        soloLetras:
          "Los apellidos sólo pueden contener letras y espacios en blanco",
      },
      email: {
  ...
  $("#crear_usuario_prueba").click(function (event) {
    ...
    $.get(
      "https://randomuser.me/api/?results=1", // API para obtener datos de usuario al azar
      function (data) {
        $.each(data.results, function (i, item) {
          // Recorrer las filas devueltas por la API
          ...
          Swal.fire({
            ...
            html: `Se ha llenado el formulario con 
